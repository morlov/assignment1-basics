...
def run_swiglu(
    ...
    swiglu_ffn.load_state_dict({'w1.weight': w1_weight, 'w2.weight': w2_weight, 'w3.weight': w3_weight})
...
def run_multihead_self_attention(
    ...
    """
    multihead_self_attention = solution_model.CausalMultiHeadSelfAttention(
        d_model=d_model,
        num_heads=num_heads,
...
def run_multihead_self_attention_with_rope(
    ...
    # multihead_self_attention.k_proj.weight.data = k_proj_weight
    # multihead_self_attention.v_proj.weight.data = v_proj_weight
    # multihead_self_attention.ootput_proj.weight.data = o_proj_weight
...
def run_transformer_block(
    ...
    transformer_block = solution_model.TransformerBlock(
        d_model=d_model,
        num_heads=num_heads,
        d_ff=d_ff,
        max_seq_len=max_seq_len,
...
def run_transformer_lm(
    ...
    transformer_lm = solution_model.TransformerLM(
...
def run_get_batch(
    ...
    """
    return solution_data.get_batch(dataset, batch_size, context_length, device)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    return solution_nn_utils.softmax(in_features, dim)
...
def run_cross_entropy(
    ...
    """
    return solution_nn_utils.cross_entropy(inputs, targets)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    return solution_optimizer.gradient_clipping(parameters, max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return solution_optimizer.lr_cosine_schedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
...
def run_save_checkpoint(
    ...
    """
    return solution_serialization.save_checkpoint(model, optimizer, iteration, out)
...
def run_load_checkpoint(
    ...
    """
    return solution_serialization.load_checkpoint(src, model, optimizer)
...
def get_tokenizer(
    ...
    """
    return solution_tokenizer.BPETokenizer(vocab, merges, special_tokens)
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    return solution_train_bpe.train_bpe(input_path, vocab_size, special_tokens, **kwargs)
